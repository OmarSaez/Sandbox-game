...
func _build_ui():
	...
	estyle.bg_color = Color(0.2, 0.2, 0.2)
	eraser_btn.add_theme_stylebox_override("normal", estyle)
	eraser_btn.pressed.connect(func(): current_brush = 0)
	...
	for i in range(1, 10):
		...
		style.bg_color = _get_display_color(i, 0)
		btn.add_theme_stylebox_override("normal", style)
		
		btn.pressed.connect(func(): current_brush = i)
	...
	canvas_bg.custom_minimum_size = Vector2(GRID_SIZE * 20, GRID_SIZE * 20)
...
func _init_grid():
	...
	for y in range(GRID_SIZE):
		...
		for x in range(GRID_SIZE):
			...
			cell.custom_minimum_size = Vector2(19, 19)
...
with open('sandbox/scripts/sandbox/npc_editor.gd', 'w', encoding='utf-8') as fout:
    fout.write(new_code)
