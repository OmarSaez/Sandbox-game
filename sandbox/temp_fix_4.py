...
# Replace _update_pipe_visuals
content = re.sub(r'func _update_pipe_visuals\(p\):.*?(?=func _update_pipe_x2_visuals\(p\):)', pipe1_code + '\n\n', content, flags=re.DOTALL)

# Replace _update_pipe_x2_visuals. Lookahead for func _find_pipe_x2_endpoint_opening_side
content = re.sub(r'func _update_pipe_x2_visuals\(p\):.*?(?=func _find_pipe_x2_endpoint_opening_side)', pipe2_code + '\n\n', content, flags=re.DOTALL)
