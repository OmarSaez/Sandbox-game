...
void initialize_sandbox_module(ModuleInitializationLevel p_level) {
	...
	GDREGISTER_CLASS(SandboxGridNode);
}
...
extern "C" {
// Initialization.
GDExtensionBool GDE_EXPORT sandbox_library_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization) {
