...
class AndroidExportPlugin extends EditorExportPlugin:
	...
	func _get_android_manifest_element_contents(platform: EditorExportPlatform, debug: bool) -> String:
		...
		__contents += '<uses-permission android:name="android.permission.POST_NOTIFICATIONS" />\n'
		__contents += '<uses-permission android:name="android.permission.RECEIVE_BOOT_COMPLETED" />\n'
		return __contents
