...
func _connect_signals() -> void:
	var gps = _get_gps()
	if gps and gps.android_plugin:
		gps.android_plugin.achievementUnlocked.connect(func(is_unlocked: bool, achievement_id: String):
			achievement_unlocked.emit(is_unlocked, achievement_id)
		)
		gps.android_plugin.achievementsLoaded.connect(func(achievements_json: String):
			var safe_array: Array[Dictionary] = gps.json_marshaller.safe_parse_array(achievements_json)
		...
		gps.android_plugin.achievementRevealed.connect(func(is_revealed: bool, achievement_id: String):
...
func increment_achievement(achievement_id: String, amount: int) -> void:
	var gps = _get_gps()
	if gps and gps.android_plugin:
		gps.android_plugin.incrementAchievement(achievement_id, amount)
...
func load_achievements(force_reload: bool) -> void:
	var gps = _get_gps()
	if gps and gps.android_plugin:
		gps.android_plugin.loadAchievements(force_reload)
...
func reveal_achievement(achievement_id: String) -> void:
	var gps = _get_gps()
	if gps and gps.android_plugin:
		gps.android_plugin.revealAchievement(achievement_id)
...
func show_achievements() -> void:
	var gps = _get_gps()
	if gps and gps.android_plugin:
		gps.android_plugin.showAchievements()
...
func unlock_achievement(achievement_id: String) -> void:
	var gps = _get_gps()
	if gps and gps.android_plugin:
		gps.android_plugin.unlockAchievement(achievement_id)
